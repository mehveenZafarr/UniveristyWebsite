...
const MobileHeader = ({authUser, setSelection}) => {
    return (
        <>
            <header className=' bg-white'>
                <div className='flex flex-col'>
                    <div className='flex items-center flex-row text-lg gap-2 rounded-xl h-auto py-2 mx-2 bg-gradient-to-r text-white border-b-2 border-primary justify-center'>
